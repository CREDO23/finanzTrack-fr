...
export default function Home() {
  ...
  return (
    <AnimatePresence>
      <div className="w-full sm:min-h-screen h-full flex flex-col relative bg-[#F2F3F5] font-inter overflow-hidden">
        <svg
        ...
        <main className="flex flex-col justify-center h-[90%] static md:fixed w-screen overflow-hidden grid-rows-[1fr_repeat(3,auto)_1fr] z-[100] pt-[30px] pb-[320px] px-4 md:px-20 md:py-0">
          <span className=" font-bold text-xl">Finanz Track</span>
          ...
          >
            Track every  <span className="text-[#407BBF]">dollard</span><br />
            effortlessly
          ...
          >
            <div className="w-1/2">
              ...
              Effortlessly monitor every penny you spend. With FinanzTrack, you&apos;re in control of your expenses.
              </p>
            </div>
            <div className="w-1/2">
              <h2 className="flex items-center font-semibold text-[1em] text-[#1a2b3b]">
              ...
              <p className="text-[14px] leading-[20px] text-[#1a2b3b] font-normal">
              Instantly view and categorize your income sources. FinanzTrack provides a clear snapshot of your earnings.
              </p>
            </div>
          </motion.div>
